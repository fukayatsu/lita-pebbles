module Lita
  module Handlers
    class Omikuji < Handler
      LOTS = {
        '大吉' => %w(万事好調なり 昇龍のごとし 飛躍の時 良き気運満つ ₍₍\ (̨̡\ ˘ω˘)̧̢\ ₎₎\ ₍₍\ (̨̡˘ω˘\ )̧̢\ ₎₎),
        '吉'   => %w(安泰の気運続く 暫く平穏なり ٩(\ ˘ω˘\ )و),
        '中吉' => %w(気運上昇の時 可なく不可もなし 満願のきざしあり 好調なるも蔭あり ﾖｻｿｳ(\ ˘ω˘)),
        '小吉' => %w(気運やや下降の時 波乱のきざしあり 気運高まるきざし 飛躍近し 待ちの時期なり ﾎｰﾎｰ↓\ ﾎｯﾎｰ↑\ (⁰⊖⁰)),
        '末吉' => %w(好転のきざしあり やや平穏が続く やや下降のきざし 蔭なくなる 気運切り開く時 もうだめだ|ωΦ\) けこが),
